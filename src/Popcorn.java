...
public static void main(String[] args) {
	...
	Popcorn el = new Popcorn("Caramel");
	e.putInMicrowave(el);
	e.setTime(2);
	e.startMicrowave();
	el.applyHeat();
	...
	el.applyHeat();
	el.applyHeat();
	el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();el.applyHeat();
}
